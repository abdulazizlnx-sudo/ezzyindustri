        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $oeeRecords; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $record): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><?php echo e($record->machine->name); ?></td>
                                <td><?php echo e($record->shift->name); ?></td>
                                <td><?php echo e(number_format($record->availability_rate, 2)); ?>%</td>
                                <td><?php echo e(number_format($record->performance_rate, 2)); ?>%</td>
                                <td><?php echo e(number_format($record->quality_rate, 2)); ?>%</td>
                                <td><?php echo e(number_format($record->oee_score, 2)); ?>%</td>
                                <td>
                                    <a href="<?php echo e(route('manajerial.oee.detail', [
...
</div><?php /**PATH /home/abdulazizurrohman/Downloads/11-EzzyIndustri-ftur-PDCA/resources/views/livewire/manajerial/oee-dashboard.blade.php ENDPATH**/ ?>