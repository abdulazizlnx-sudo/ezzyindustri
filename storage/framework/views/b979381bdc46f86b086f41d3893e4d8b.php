        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-body">
                    ...
                    <h2 class="card-title mb-2"><?php echo e($oeeData?->quality_rate ?? 0); ?>%</h2>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-4">
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold"><?php echo e($oeeData?->availability_rate ?? 0); ?>%</span>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold"><?php echo e($oeeData?->performance_rate ?? 0); ?>%</span>
                        </div>
                        <div class="progress mb-4">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span class="fw-bold"><?php echo e($oeeData?->quality_rate ?? 0); ?>%</span>
                        </div>
                        <div class="progress mb-4">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <span class="fw-bold"><?php echo e($oeeData?->oee_score ?? 0); ?>%</span>
                        </div>
                    </div>
                </div>
            </div>
