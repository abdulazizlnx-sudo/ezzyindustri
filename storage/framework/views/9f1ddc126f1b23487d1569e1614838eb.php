            ...
            <div class="col-md-3">
                <div class="card bg-primary text-white">
                    <div class="card-body">
                        ...
                        <h2 class="card-title mb-0"><?php echo e($totalMachines ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card bg-success text-white">
                    <div class="card-body">
                        ...
                        <h2 class="card-title mb-0"><?php echo e($activeProductions ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card bg-warning text-white">
                    <div class="card-body">
                        ...
                        <h2 class="card-title mb-0"><?php echo e($pendingProblems ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card bg-danger text-white">
                    <div class="card-body">
                        ...
                        <h2 class="card-title mb-0"><?php echo e($unresolvedProblems ?? 0); ?></h2>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
                <div class="card bg-info text-white">
                    <div class="card-body">
                        ...
                        <h2 class="card-title mb-0"><?php echo e($todayDowntime ?? '0 Jam'); ?></h2>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('manajerial.production.problems')); ?>" class="btn btn-primary">Lihat Problems</a>
                            <a href="<?php echo e(route('manajerial.oee.dashboard')); ?>" class="btn btn-outline-primary">OEE Dashboard</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="d-grid gap-2">
                            <a href="<?php echo e(route('manajerial.machines')); ?>" class="btn btn-primary">Kelola Mesin</a>
...
</div><?php /**PATH /home/abdulazizurrohman/Downloads/11-EzzyIndustri-ftur-PDCA/resources/views/livewire/manajerial/dashboard.blade.php ENDPATH**/ ?>