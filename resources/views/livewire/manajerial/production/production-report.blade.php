                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach($productions as $production)
                            <tr>
                                <td>{{ $production->start_time->format('d/m/Y') }}</td>
                                <td>{{ $production->shift->name ?? 'N/A' }}</td>
                                ...
                                <td>{{ $production->oeeRecord->oee_score ?? 'N/A' }}%</td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
    ...
    <script>
        document.addEventListener('livewire:initialized', () => {
            const productionChart = new ApexCharts(document.querySelector("#productionVsTargetChart"), {
                series: @json($chartData['production']),
                chart: {
                    type: 'bar',
                    height: 350
                },
